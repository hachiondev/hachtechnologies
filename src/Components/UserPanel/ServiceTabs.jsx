          ...
          <Tab.Content>
            <Tab.Pane eventKey="application">
              <Row className="align-items-top">
                ...
                <Col md={6}>
                  <h4 style={{ color: '#0D6EFD' }}>Application Services</h4>
                  <p>
            ...
            <Tab.Pane eventKey="business">
              <Row className="align-items-top">
                ...
                <Col md={6}>
                  <h4 style={{ color: '#0D6EFD' }}>Business Service</h4>
                  <p>
            ...
            <Tab.Pane eventKey="training">
              <Row className="align-items-top">
                ...
                <Col md={6}>
                  <h4 style={{ color: '#0D6EFD' }}>Technology Trainings</h4>
                  <p>
            ...
            <Tab.Pane eventKey="staffing">
              <Row className="align-items-top">
                ...
                <Col md={6}>
                  <h4 style={{ color: '#0D6EFD' }}>Global Staffing</h4>
                  <p>
